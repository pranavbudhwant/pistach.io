    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(savedInstanceState!=null && savedInstanceState.getIntegerArrayList("movieIDs")!=null){
            for(Integer mid:savedInstanceState.getIntegerArrayList("movieIDs")){
                mList.add(new item("https://firebasestorage.googleapis.com/v0/b/pistachio-8f641.appspot.com/o/images%2F" + mid.toString() + ".jpg?alt=media&token=baff526a-ac90-4390-84ac-da4b9ee0f29a", mid.intValue(), prediction[mid.intValue()], "Recommended"));
            }
